 ...
 */
SWITCH_MODULE_DEFINITION(mod_yandex_transcribe, mod_yandex_transcribe_load, mod_yandex_transcribe_shutdown, NULL);
...
static switch_status_t do_config(switch_bool_t reload)
{
	...
	if (switch_xml_config_parse_module_settings("yandex_transcribe.conf", reload, instructions) != SWITCH_STATUS_SUCCESS) {
		switch_log_printf(SWITCH_CHANNEL_LOG, SWITCH_LOG_CRIT, "Could not open yandex_transcribe.conf\n");
